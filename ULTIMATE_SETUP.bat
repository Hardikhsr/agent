...
:: Use "%~dp0*" instead of "." to avoid UAC working directory issues
...
:: Force recompile ScreenCap on target machine (CPU/DPI specific) — but ONLY if CSC is available
...
:: This protects the folder while still allowing admin re-installs
